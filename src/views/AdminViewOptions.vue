<script setup>
  ...
  import AdminOptionCard from "../components/card/AdminOptionCard.vue";
  ...
  const removeOption = (id) => {
    options.value = options.value.filter((n) => n.id != id);
  };
</script>
...
<template>
  <main v-if="loggedIn">
    <div class="background">
      <Hero></Hero>
      <div v-if="loadedOptions" class="option-cards">
        <div class="margins">
          <h1 class="option-cards-section-first">.admin_view_options</h1>
          <div class="container">
            <ul v-if="loadedOptions">
