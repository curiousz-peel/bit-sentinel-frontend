<script setup>
  ...
  import AdminLessonCard from "../components/card/AdminLessonCard.vue";
  ...
  const removeLesson = (id) => {
    lessons.value = lessons.value.filter((n) => n.id != id);
  };
</script>
...
<template>
  <main v-if="loggedIn">
    <div class="background">
      <Hero></Hero>
      <div v-if="loadedLessons" class="lesson-cards">
        <div class="margins">
          <h1 class="lesson-cards-section-first">.admin_view_lessons</h1>
          <div class="container">
            <ul v-if="loadedLessons">
              <TransitionGroup name="lessons">
